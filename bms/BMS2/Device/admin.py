...
from .models import Bms_bulding_master, Bms_floor_master, Bms_department_master, Bms_sub_area_master, Bms_locker, Bms_access_control_rfid_master, Bms_history, Bms_settings,Bms_device_information,Bms_hardware_type_master,Bms_device_type_master
...
class Bms_settingsAdmin(admin.ModelAdmin):
    list_display=['id','device_name','created_at']
