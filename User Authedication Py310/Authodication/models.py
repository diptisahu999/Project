...
class Bms_User_Type(models.Model):
    type_name=models.ManyToManyField(Bms_Roles,blank=True)
...
class Bms_Users(models.Model):
    ...
    user_type_id=models.ManyToManyField(Bms_User_Type,blank=True)
    role_id=models.ManyToManyField(Bms_Roles,blank=True)
...
class Bms_Users_Details(models.Model):
    ...
    role_id=models.ManyToManyField(Bms_Roles,blank=True)
    # department_id=models.ForeignKey(Bms_department_master,on_delete=models.CASCADE)
    # locker_id=models.ForeignKey(Bms_locker,on_delete=models.CASCADE)
    department_id=models.ManyToManyField(Bms_department_master,blank=True)
    locker_id=models.ManyToManyField(Bms_locker,blank=True)
