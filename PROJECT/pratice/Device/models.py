...
class Bms_access_control_rfid_master(models.Model):
    ...
    user_id=models.ManyToManyField(to='Authodication.Bms_Users')
...
class Bms_history(models.Model):
    ...
    user_id=models.ManyToManyField(to='Authodication.Bms_Users', blank=True)
    # user_id=models.ManyToManyField(Bms_Users, blank=True)
...
class Bms_settings(models.Model):
    module_id=models.ManyToManyField(to='Authodication.Bms_Module_master',blank=True)
